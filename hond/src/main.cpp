...
//dit is de code met gebruik van irq, maar deze werkt onstabiel, werkt de ene dag, de andere dag niet meer.
// de code hierboven is zonder functionerende irq, en polt dus constant alsof er een kaart gedetecteerd is.
...
//       }
//   } else {
//     Serial.println("_______________geluid_______________");
//     Serial.print("MOD done");
//     Serial.print(" gain en audio file: (0 is blaffen): ");
//     Serial.print(gain);
//     Serial.print(" , ");
